...
class Account(NestedSet):
	...
	def autoname(self):
		from shopper.accounts.utils import get_autoname_with_number

		self.name = get_autoname_with_number(self.account_number, self.account_name, self.company)

	def validate(self):
		from shopper.accounts.utils import validate_field_number
				...
				doc.update(
					{
						...
						else shopper.get_company_currency(company),
