...
from shopper.accounts.doctype.payment_entry.payment_entry import (
	get_company_defaults,
	get_payment_entry,
)
from shopper.accounts.doctype.subscription_plan.subscription_plan import get_plan_rate
from shopper.accounts.party import get_party_account, get_party_bank_account
from shopper.accounts.utils import get_account_currency
from shopper.utilities import payment_app_import_guard
...
def make_payment_request(**args):
	...
	if args.loyalty_points and args.dt == "Sales Order":
		from shopper.accounts.doctype.loyalty_program.loyalty_program import validate_loyalty_points
...
def update_payment_req_status(doc, method):
	from shopper.accounts.doctype.payment_entry.payment_entry import get_reference_details
