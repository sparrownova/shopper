...
shopper.accounts.pos.setup("POS Invoice");
shopper.selling.POSInvoiceController = class POSInvoiceController extends shopper.selling.SellingController {
	settings = {};
...
extend_cscript(cur_frm.cscript, new shopper.selling.POSInvoiceController({ frm: cur_frm }))
