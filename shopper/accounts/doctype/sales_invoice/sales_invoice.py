...
import shopper
from shopper.accounts.deferred_revenue import validate_service_stop_date
from shopper.accounts.doctype.loyalty_program.loyalty_program import (
	get_loyalty_program_details_with_points,
	validate_loyalty_points,
)
from shopper.accounts.doctype.repost_accounting_ledger.repost_accounting_ledger import (
	validate_docs_for_deferred_accounting,
)
from shopper.accounts.doctype.tax_withholding_category.tax_withholding_category import (
	get_party_tax_withholding_details,
)
from shopper.accounts.general_ledger import get_round_off_account_and_cost_center
from shopper.accounts.party import get_due_date, get_party_account, get_party_details
from shopper.accounts.utils import cancel_exchange_gain_loss_journal, get_account_currency
from shopper.assets.doctype.asset.depreciation import (
	depreciate_asset,
...
from shopper.assets.doctype.asset_activity.asset_activity import add_asset_activity
from shopper.controllers.accounts_controller import validate_account_head
from shopper.controllers.selling_controller import SellingController
from shopper.projects.doctype.timesheet.timesheet import get_projectwise_timesheet_data
from shopper.setup.doctype.company.company import update_company_current_month_sales
from shopper.stock.doctype.delivery_note.delivery_note import update_billed_amount_based_on_so
from shopper.stock.doctype.serial_no.serial_no import get_delivery_note_serial_no, get_serial_nos
...
class SalesInvoice(SellingController):
	...
	def check_credit_limit(self):
		from shopper.selling.doctype.customer.customer import check_credit_limit
	...
	def set_pos_fields(self, for_validate=False):
		...
		from shopper.stock.get_item_details import get_pos_profile, get_pos_profile_item_details
	...
	def update_packing_list(self):
		if cint(self.update_stock) == 1:
			from shopper.stock.doctype.packed_item.packed_item import make_packing_list
	...
	def make_gl_entries(self, gl_entries=None, from_repost=False):
		from shopper.accounts.general_ledger import make_gl_entries, make_reverse_gl_entries

		auto_accounting_for_stock = shopper.is_perpetual_inventory_enabled(self.company)
		if not gl_entries:
		...
		if gl_entries:
			...
			if update_outstanding == "No":
				from shopper.accounts.doctype.gl_entry.gl_entry import update_outstanding_amt
	...
	def get_gl_entries(self, warehouse_account=None):
		from shopper.accounts.general_ledger import merge_similar_entries
	...
	def make_item_gl_entries(self, gl_entries):
		...
		if cint(self.update_stock) and shopper.is_perpetual_inventory_enabled(self.company):
	...
	def apply_loyalty_points(self):
		from shopper.accounts.doctype.loyalty_point_entry.loyalty_point_entry import (
...
def get_list_context(context=None):
	from shopper.controllers.website_list_for_contact import get_list_context
...
def get_loyalty_programs(customer):
	...
	from shopper.selling.doctype.customer.customer import get_loyalty_programs
...
def create_dunning(source_name, target_doc=None, ignore_permissions=False):
	...
	def postprocess_dunning(source, target):
		from shopper.accounts.doctype.dunning.dunning import get_dunning_letter_text
