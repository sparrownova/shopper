...
import shopper
from shopper.assets.doctype.asset.asset import get_asset_value_after_depreciation
...
from shopper.stock.utils import get_incoming_rate
		...
		for item_row in self.stock_items:
			...
			if sle_list:
				for sle in sle_list:
					...
					if shopper.is_perpetual_inventory_enabled(self.company):
