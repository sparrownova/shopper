...
from shopper.accounts.party import get_due_date_from_template
from shopper.buying.doctype.purchase_order.purchase_order import make_inter_company_sales_order
...
from shopper.controllers.accounts_controller import update_child_qty_rate
from shopper.manufacturing.doctype.blanket_order.test_blanket_order import make_blanket_order
...
class TestPurchaseOrder(FrappeTestCase):
	...
	def test_purchase_order_invoice_receipt_workflow(self):
		from shopper.accounts.doctype.purchase_invoice.purchase_invoice import make_purchase_receipt
	...
	def test_warehouse_company_validation(self):
		from shopper.stock.utils import InvalidWarehouseCompany

		po = create_purchase_order(company="_Test Company 1", do_not_save=True)
		self.assertRaises(InvalidWarehouseCompany, po.insert)

	def test_uom_integer_validation(self):
		from shopper.utilities.transaction_base import UOMMustBeIntegerError
	...
	def test_update_items_for_subcontracting_purchase_order(self):
		from shopper.controllers.tests.test_subcontracting_controller import (
