...
from shopper.controllers.website_list_for_contact import get_customers_suppliers
from shopper.exceptions import PartyDisabled
...
class TestSupplier(FrappeTestCase):
	...
	def test_serach_fields_for_supplier(self):
		from shopper.controllers.queries import supplier_query
