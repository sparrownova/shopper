- Enhancements
	...
	- Other Features
		...
		- A free marketplace where any Shopper user can list their products and be discovered by thousands of other companies using Shopper
...
- Changes have been made to ensure Shopper is compatible with Python 3
