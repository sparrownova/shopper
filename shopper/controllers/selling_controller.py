...
from shopper.accounts.party import render_address
from shopper.controllers.accounts_controller import get_taxes_and_charges
from shopper.controllers.sales_and_purchase_return import get_rate_for_return
from shopper.controllers.stock_controller import StockController
from shopper.stock.doctype.item.item import set_item_default
from shopper.stock.get_item_details import get_bin_details, get_conversion_factor
...
class SellingController(StockController):
	...
	def set_missing_lead_customer_details(self, for_validate=False):
		...
		if customer:
			from shopper.accounts.party import _get_party_details
			...
			from shopper.crm.doctype.lead.lead import get_lead_details
	...
	def validate_items(self):
		...
		from shopper.controllers.buying_controller import validate_item_type
