...
shopper.maintenance.MaintenanceSchedule = class MaintenanceSchedule extends frappe.ui.form.Controller {
	refresh() {
...
extend_cscript(cur_frm.cscript, new shopper.maintenance.MaintenanceSchedule({frm: cur_frm}));
