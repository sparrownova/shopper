...
shopper.bom.BomConfigurator = class BomConfigurator extends shopper.TransactionController {
	conversion_rate(doc) {
...
extend_cscript(cur_frm.cscript, new shopper.bom.BomConfigurator({frm: cur_frm}));