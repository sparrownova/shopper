...
from shopper.manufacturing.doctype.job_card.job_card import JobCardCancelError
...
from shopper.stock.doctype.stock_entry import test_stock_entry
...
class TestWorkOrder(FrappeTestCase):
	...
	def test_wo_completion_with_pl_bom(self):
		from shopper.manufacturing.doctype.bom.test_bom import (
...
def prepare_data_for_workstation_type_check():
	from shopper.manufacturing.doctype.operation.test_operation import make_operation
	from shopper.manufacturing.doctype.workstation.test_workstation import make_workstation
	from shopper.manufacturing.doctype.workstation_type.test_workstation_type import (
