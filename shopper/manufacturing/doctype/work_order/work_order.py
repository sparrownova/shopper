...
from shopper.manufacturing.doctype.bom.bom import (
	get_bom_item_rate,
	get_bom_items_as_dict,
	validate_bom_no,
)
from shopper.manufacturing.doctype.manufacturing_settings.manufacturing_settings import (
	get_mins_between_operations,
)
from shopper.stock.doctype.batch.batch import make_batch
from shopper.stock.doctype.item.item import get_item_defaults, validate_end_of_life
from shopper.stock.doctype.serial_no.serial_no import get_available_serial_nos, get_serial_nos
from shopper.stock.stock_balance import get_planned_qty, update_bin_qty
from shopper.stock.utils import get_bin, get_latest_stock_qty, validate_warehouse_company
...
class WorkOrder(Document):
	...
	def update_work_order_qty(self):
		...
		for purpose, fieldname in (
			...
			from shopper.selling.doctype.sales_order.sales_order import update_produced_qty_in_so_item
...
def make_stock_return_entry(work_order):
	from shopper.stock.doctype.stock_entry.stock_entry import get_available_materials
