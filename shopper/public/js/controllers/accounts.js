...
// get tax rate
frappe.provide("shopper.taxes");

shopper.accounts.taxes = {
			...
			onload: function(frm) {
				if(frm.get_field("taxes")) {
					frm.set_query("account_head", "taxes", function(doc) {
						...
						return {
							query: "shopper.controllers.queries.tax_account_query",
							filters: {
		...
		frappe.ui.form.on(doctype, {
			account_head: function(frm, cdt, cdn) {
				...
				if(!d.charge_type && d.account_head){
					...
					frappe.call({
						type:"GET",
						method: "shopper.controllers.accounts_controller.get_tax_rate",
...
shopper.accounts.payment_triggers = {
...
shopper.accounts.pos = {
	...
	get_payment_mode_account: function(frm, mode_of_payment, callback) {
		...
		return  frappe.call({
			method: "shopper.accounts.doctype.sales_invoice.sales_invoice.get_bank_cash_account",
			args: {
