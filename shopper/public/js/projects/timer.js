frappe.provide("shopper.timesheet");

shopper.timesheet.timer = function(frm, row, timestamp=0) {
	...
	shopper.timesheet.control_timer(frm, dialog, row, timestamp);
	dialog.show();
};

shopper.timesheet.control_timer = function(frm, dialog, row, timestamp=0) {
