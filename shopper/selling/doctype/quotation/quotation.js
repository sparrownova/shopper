...
shopper.accounts.taxes.setup_tax_validations("Sales Taxes and Charges Template");
shopper.accounts.taxes.setup_tax_filters("Sales Taxes and Charges");
shopper.pre_sales.set_as_lost("Quotation");
...
shopper.selling.QuotationController = class QuotationController extends shopper.selling.SellingController {
	onload(doc, dt, dn) {
	...
	get_lead_details() {
		...
		frappe.call({
			method: "shopper.crm.doctype.lead.lead.get_lead_details",
			args: {
...
cur_frm.script_manager.make(shopper.selling.QuotationController);
