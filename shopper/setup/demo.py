...
from shopper.buying.doctype.purchase_order.purchase_order import make_purchase_invoice
...
def setup_demo_data():
	...
	capture("demo_data_creation_started", "shopper")
	try:
		...
		capture("demo_data_creation_failed", "shopper", properties={"exception": frappe.get_traceback()})
		raise
	capture("demo_data_creation_completed", "shopper")
...
def clear_demo_data():
	...
	capture("demo_data_erased", "shopper")
	try:
