...
shopper.landed_cost_taxes_and_charges.setup_triggers("Landed Cost Voucher");
shopper.stock.LandedCostVoucher = class LandedCostVoucher extends shopper.stock.StockController {
	setup() {
		var me = this;
...
cur_frm.script_manager.make(shopper.stock.LandedCostVoucher);
