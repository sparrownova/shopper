...
import shopper
from shopper.accounts.general_ledger import validate_accounting_period
from shopper.accounts.utils import get_future_stock_vouchers, repost_gle_for_stock_vouchers
from shopper.stock.stock_ledger import (
...
def repost_gl_entries(doc):
	if not cint(shopper.is_perpetual_inventory_enabled(doc.company)):
		return
