...
from shopper.stock.doctype.batch.batch import get_available_batches, get_batch_qty
from shopper.stock.doctype.inventory_dimension.inventory_dimension import get_inventory_dimensions
...
class StockReconciliation(StockController):
	...
	def validate_item(self, item_code, row):
		from shopper.stock.doctype.item.item import (
	...
	def recalculate_current_qty(self, item_code, batch_no):
		from shopper.stock.stock_ledger import get_valuation_rate
...
def get_itemwise_batch(warehouse, posting_date, company, item_code=None):
	from shopper.stock.report.batch_wise_balance_history.batch_wise_balance_history import execute
