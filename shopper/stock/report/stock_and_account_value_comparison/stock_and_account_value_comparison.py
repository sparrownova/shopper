...
import shopper
from shopper.accounts.utils import get_currency_precision, get_stock_accounts
from shopper.stock.doctype.warehouse.warehouse import get_warehouses_based_on_account


def execute(filters=None):
	if not shopper.is_perpetual_inventory_enabled(filters.company):
		frappe.throw(
