...
shopper.landed_cost_taxes_and_charges.setup_triggers("Subcontracting Order");
...
shopper.buying.SubcontractingOrderController = class SubcontractingOrderController {
	setup() {
	...
	make_subcontracting_receipt() {
		frappe.model.open_mapped_doc({
			method: 'shopper.subcontracting.doctype.subcontracting_order.subcontracting_order.make_subcontracting_receipt',
			frm: cur_frm,
...
extend_cscript(cur_frm.cscript, new shopper.buying.SubcontractingOrderController({ frm: cur_frm }));