...
frappe.provide("shopper.support");
...
shopper.support.WarrantyClaim = class WarrantyClaim extends frappe.ui.form.Controller {
	refresh() {
...
extend_cscript(cur_frm.cscript, new shopper.support.WarrantyClaim({frm: cur_frm}));
