...
def task(doc_name, from_doctype, to_doctype):
	from shopper.accounts.doctype.payment_entry import payment_entry
	from shopper.accounts.doctype.purchase_invoice import purchase_invoice
	from shopper.accounts.doctype.sales_invoice import sales_invoice
	from shopper.buying.doctype.purchase_order import purchase_order
	from shopper.buying.doctype.supplier_quotation import supplier_quotation
	from shopper.selling.doctype.quotation import quotation
	from shopper.selling.doctype.sales_order import sales_order
	from shopper.stock.doctype.delivery_note import delivery_note
	from shopper.stock.doctype.purchase_receipt import purchase_receipt
